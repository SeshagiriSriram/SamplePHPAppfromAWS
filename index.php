...
<head>
    ...
    <title>Sample PHP Application - AWS Elastic Beanstalk - Sriram/Devops</title>
...
<body>
    ...
    <section class="instructions">
	    <h2>Sample Links to custom PHP code </h2> 
		<ul> 
		   <li><a href="./samplehello.php">The mandatory Hello World Program </a></li>
		   <li><a href="./info.php">Info about your PHP installation </a></li>
		</ul> 
        <h2>What's Next?</h2>
        <ul>
